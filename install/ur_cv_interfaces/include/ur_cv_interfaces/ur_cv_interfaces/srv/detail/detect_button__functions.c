...
ur_cv_interfaces__srv__DetectButton_Request__init(ur_cv_interfaces__srv__DetectButton_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->label)) {
    ur_cv_interfaces__srv__DetectButton_Request__fini(msg);
    return false;
  }
  return true;
}
...
ur_cv_interfaces__srv__DetectButton_Request__create()
{
  ...
  ur_cv_interfaces__srv__DetectButton_Request * msg = (ur_cv_interfaces__srv__DetectButton_Request *)allocator.allocate(sizeof(ur_cv_interfaces__srv__DetectButton_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ur_cv_interfaces__srv__DetectButton_Request));
  bool success = ur_cv_interfaces__srv__DetectButton_Request__init(msg);
  if (!success) {
...
ur_cv_interfaces__srv__DetectButton_Request__Sequence__init(ur_cv_interfaces__srv__DetectButton_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_cv_interfaces__srv__DetectButton_Request * data = NULL;

  if (size) {
    data = (ur_cv_interfaces__srv__DetectButton_Request *)allocator.zero_allocate(size, sizeof(ur_cv_interfaces__srv__DetectButton_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ur_cv_interfaces__srv__DetectButton_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ur_cv_interfaces__srv__DetectButton_Request__fini(&data[i - 1]);
      }
...
ur_cv_interfaces__srv__DetectButton_Request__Sequence__fini(ur_cv_interfaces__srv__DetectButton_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ur_cv_interfaces__srv__DetectButton_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_cv_interfaces__srv__DetectButton_Request__Sequence * array = (ur_cv_interfaces__srv__DetectButton_Request__Sequence *)allocator.allocate(sizeof(ur_cv_interfaces__srv__DetectButton_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ur_cv_interfaces__srv__DetectButton_Request__Sequence__init(array, size);
  if (!success) {
...
ur_cv_interfaces__srv__DetectButton_Request__Sequence__destroy(ur_cv_interfaces__srv__DetectButton_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ur_cv_interfaces__srv__DetectButton_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ur_cv_interfaces__srv__DetectButton_Request__Sequence__are_equal(const ur_cv_interfaces__srv__DetectButton_Request__Sequence * lhs, const ur_cv_interfaces__srv__DetectButton_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur_cv_interfaces__srv__DetectButton_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur_cv_interfaces__srv__DetectButton_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur_cv_interfaces__srv__DetectButton_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur_cv_interfaces__srv__DetectButton_Request * data =
      (ur_cv_interfaces__srv__DetectButton_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_cv_interfaces__srv__DetectButton_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur_cv_interfaces__srv__DetectButton_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ur_cv_interfaces__srv__DetectButton_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_cv_interfaces__srv__DetectButton_Response * msg = (ur_cv_interfaces__srv__DetectButton_Response *)allocator.allocate(sizeof(ur_cv_interfaces__srv__DetectButton_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ur_cv_interfaces__srv__DetectButton_Response));
  bool success = ur_cv_interfaces__srv__DetectButton_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ur_cv_interfaces__srv__DetectButton_Response__destroy(ur_cv_interfaces__srv__DetectButton_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ur_cv_interfaces__srv__DetectButton_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ur_cv_interfaces__srv__DetectButton_Response__Sequence__init(ur_cv_interfaces__srv__DetectButton_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_cv_interfaces__srv__DetectButton_Response * data = NULL;

  if (size) {
    data = (ur_cv_interfaces__srv__DetectButton_Response *)allocator.zero_allocate(size, sizeof(ur_cv_interfaces__srv__DetectButton_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ur_cv_interfaces__srv__DetectButton_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ur_cv_interfaces__srv__DetectButton_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ur_cv_interfaces__srv__DetectButton_Response__Sequence__fini(ur_cv_interfaces__srv__DetectButton_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ur_cv_interfaces__srv__DetectButton_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_cv_interfaces__srv__DetectButton_Response__Sequence * array = (ur_cv_interfaces__srv__DetectButton_Response__Sequence *)allocator.allocate(sizeof(ur_cv_interfaces__srv__DetectButton_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ur_cv_interfaces__srv__DetectButton_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ur_cv_interfaces__srv__DetectButton_Response__Sequence__destroy(ur_cv_interfaces__srv__DetectButton_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ur_cv_interfaces__srv__DetectButton_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ur_cv_interfaces__srv__DetectButton_Response__Sequence__are_equal(const ur_cv_interfaces__srv__DetectButton_Response__Sequence * lhs, const ur_cv_interfaces__srv__DetectButton_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur_cv_interfaces__srv__DetectButton_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur_cv_interfaces__srv__DetectButton_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur_cv_interfaces__srv__DetectButton_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur_cv_interfaces__srv__DetectButton_Response * data =
      (ur_cv_interfaces__srv__DetectButton_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_cv_interfaces__srv__DetectButton_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur_cv_interfaces__srv__DetectButton_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ur_cv_interfaces__srv__DetectButton_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
